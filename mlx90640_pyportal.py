...
scale_group = displayio.Group(scale=4)
scale_tile = displayio.TileGrid(scale_bitmap, pixel_shader=palette, x = 0, y = 52)
...
min_label = Label(terminalio.FONT, max_glyphs=10, color=palette[0])
center_label = Label(terminalio.FONT, max_glyphs=10, color=palette[int(number_of_colors/2)])
max_label = Label(terminalio.FONT, max_glyphs=10, color=palette[last_color])
